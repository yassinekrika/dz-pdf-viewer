...
> PDF Viewer Component for Angular 19+
...
export class AppComponent {
  pdfSrc = "https://yassinekrika.github.io/dz-pdf-viewer/assets/pdf-test.pdf";
}
```
...
```
[src]="'https://yassinekrika.github.io/dz-pdf-viewer/assets/pdf-test.pdf'"
```
...
Options object for loading protected PDF would be:
 ...
 ```js
 {
  url: 'https://yassinekrika.github.io/dz-pdf-viewer/assets/pdf-test.pdf',
